...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'alerts_alertsubscription', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alert', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subscriptions', to=orm['alerts.AlertType'])),
        ...
        db.send_create_signal(u'alerts', ['AlertSubscription'])


    def backwards(self, orm):
        # Deleting model 'AlertSubscription'
        db.delete_table(u'alerts_alertsubscription')
