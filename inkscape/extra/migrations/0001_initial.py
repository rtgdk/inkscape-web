...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'extra_tab', (
            ...
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='front_tabs', null=True, to=orm['auth.User'])),
            ('download', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('license', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resource.License'])),
