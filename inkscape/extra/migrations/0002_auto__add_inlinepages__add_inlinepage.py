...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'InlinePages'
        db.create_table(u'extra_inlinepages', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'extra', ['InlinePages'])

        # Adding model 'InlinePage'
        db.create_table(u'extra_inlinepage', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ))
        db.send_create_signal(u'extra', ['InlinePage'])


    def backwards(self, orm):
        # Deleting model 'InlinePages'
        db.delete_table(u'extra_inlinepages')

        # Deleting model 'InlinePage'
        db.delete_table(u'extra_inlinepage')
