...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ShieldPlugin'
        db.create_table(u'extra_shieldplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'extra', ['ShieldPlugin'])

        # Adding model 'TabCategory'
        ...
        # Adding model 'Tab'
        db.create_table(u'extra_tab', (
            (u'resourcefile_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['resource.ResourceFile'], unique=True, primary_key=True)),
            ('order', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tab_name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('tab_text', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('tab_cat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['extra.TabCategory'])),
            ('banner_text', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('banner_foot', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True)),
            ('btn_text', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
            ('btn_link', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('btn_icon', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('shield', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tabs', to=orm['extra.ShieldPlugin'])),
            ('draft', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['extra.Tab'], null=True, blank=True)),
        ))
        db.send_create_signal(u'extra', ['Tab'])


    def backwards(self, orm):
        # Deleting model 'ShieldPlugin'
        db.delete_table(u'extra_shieldplugin')

        # Deleting model 'TabCategory'
        db.delete_table(u'extra_tabcategory')

        # Deleting model 'Tab'
        db.delete_table(u'extra_tab')
    ...
    models = {
        ...
        u'extra.tab': {
            'Meta': {'ordering': "('order',)", 'object_name': 'Tab', '_ormbases': [u'resource.ResourceFile']},
            ...
            u'resourcefile_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['resource.ResourceFile']", 'unique': 'True', 'primary_key': 'True'}),
