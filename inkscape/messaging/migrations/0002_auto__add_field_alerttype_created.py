...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AlertType.created'
        db.add_column(u'messaging_alerttype', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AlertType.created'
        db.delete_column(u'messaging_alerttype', 'created')
