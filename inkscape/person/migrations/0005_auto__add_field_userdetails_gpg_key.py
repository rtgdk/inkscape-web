...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserDetails.gpg_key'
        db.add_column(u'person_userdetails', 'gpg_key',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserDetails.gpg_key'
        db.delete_column(u'person_userdetails', 'gpg_key')
