...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'resource_galleryplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('limit', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resource.Gallery'])),
        ))
        db.send_create_signal(u'resource', ['GalleryPlugin'])

        # Adding model 'CategoryPlugin'
        db.create_table(u'resource_categoryplugin', (
            (u'cmsplugin_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['cms.CMSPlugin'], unique=True, primary_key=True)),
            ('limit', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resource.Category'])),
        ))
        db.send_create_signal(u'resource', ['CategoryPlugin'])


    def backwards(self, orm):
        # Deleting model 'GalleryPlugin'
        db.delete_table(u'resource_galleryplugin')

        # Deleting model 'CategoryPlugin'
        db.delete_table(u'resource_categoryplugin')
