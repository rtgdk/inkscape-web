...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'inline_templates.inlinetemplate': {
            'Meta': {'object_name': 'InlineTemplate'},
            'base': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
        ...
        u'resource.categoryplugin': {
            ...
            'template': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inline_templates.InlineTemplate']", 'null': 'True', 'blank': 'True'})
        },
        u'resource.gallery': {
