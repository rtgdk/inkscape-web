...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'resource_galleryplugin', 'template_id')

        # Adding field 'GalleryPlugin.display'
        db.add_column(u'resource_galleryplugin', 'display',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CategoryPlugin.template'
        db.delete_column(u'resource_categoryplugin', 'template_id')

        # Adding field 'CategoryPlugin.display'
        db.add_column(u'resource_categoryplugin', 'display',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'resource_galleryplugin', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inline_templates.InlineTemplate'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'GalleryPlugin.display'
        db.delete_column(u'resource_galleryplugin', 'display')

        # Adding field 'CategoryPlugin.template'
        db.add_column(u'resource_categoryplugin', 'template',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inline_templates.InlineTemplate'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CategoryPlugin.display'
        db.delete_column(u'resource_categoryplugin', 'display')
