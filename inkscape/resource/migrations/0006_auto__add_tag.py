...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tag'
        db.create_table(u'resource_tag', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['resource.Tag'], null=True, blank=True)),
        ))
        db.send_create_signal(u'resource', ['Tag'])

        # Adding M2M table for field tags on 'Resource'
        m2m_table_name = db.shorten_name(u'resource_resource_tags')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('resource', models.ForeignKey(orm[u'resource.resource'], null=False)),
            ('tag', models.ForeignKey(orm[u'resource.tag'], null=False))
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'Tag'
        db.delete_table(u'resource_tag')

        # Removing M2M table for field tags on 'Resource'
        db.delete_table(db.shorten_name(u'resource_resource_tags'))
