...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Resource.media_x'
        db.add_column(u'resource_resource', 'media_x',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Resource.media_y'
        db.add_column(u'resource_resource', 'media_y',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.media_x'
        db.delete_column(u'resource_resource', 'media_x')

        # Deleting field 'Resource.media_y'
        db.delete_column(u'resource_resource', 'media_y')
