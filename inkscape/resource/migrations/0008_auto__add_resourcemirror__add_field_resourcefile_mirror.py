...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResourceMirror'
        db.create_table(u'resource_resourcemirror', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(default=UUID('ade52c39-1f07-43d5-91a4-1c59a2c21b81'), max_length=64)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('manager', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'])),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200)),
            ('capacity', self.gf('django.db.models.fields.PositiveIntegerField')()),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('sync_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('sync_count', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('chk_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True)),
            ('chk_return', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'resource', ['ResourceMirror'])

        # Adding field 'ResourceFile.mirror'
        db.add_column(u'resource_resourcefile', 'mirror',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResourceMirror'
        db.delete_table(u'resource_resourcemirror')

        # Deleting field 'ResourceFile.mirror'
        db.delete_column(u'resource_resourcefile', 'mirror')
    ...
    models = {
        ...
        u'resource.resourcemirror': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('98e003f5-bec3-4f5f-8182-9fd8fb797ea2')", 'max_length': '64'})
        },
        u'resource.tag': {
