...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResourceFile.signature'
        db.add_column(u'resource_resourcefile', 'signature',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ResourceFile.verified'
        db.add_column(u'resource_resourcefile', 'verified',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResourceFile.signature'
        db.delete_column(u'resource_resourcefile', 'signature')

        # Deleting field 'ResourceFile.verified'
        db.delete_column(u'resource_resourcefile', 'verified')
    ...
    models = {
        ...
        u'resource.resourcemirror': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('7cac4da6-1eb5-473d-8502-befac345ec03')", 'max_length': '64'})
        },
        u'resource.tag': {
