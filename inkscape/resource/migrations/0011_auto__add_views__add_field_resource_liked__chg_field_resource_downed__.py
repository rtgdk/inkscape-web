...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Views'
        db.create_table(u'resource_views', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('resource', self.gf('django.db.models.fields.related.ForeignKey')(related_name='views', to=orm['resource.Resource'])),
            ('session', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal(u'resource', ['Views'])

        # Adding field 'Resource.liked'
        db.add_column(u'resource_resource', 'liked',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Resource.downed'
        db.alter_column(u'resource_resource', 'downed', self.gf('django.db.models.fields.PositiveIntegerField')())

        # Changing field 'Resource.viewed'
        db.alter_column(u'resource_resource', 'viewed', self.gf('django.db.models.fields.PositiveIntegerField')())
        # Deleting field 'Vote.vote'
        db.delete_column(u'resource_vote', 'vote')


    def backwards(self, orm):
        # Deleting model 'Views'
        db.delete_table(u'resource_views')

        # Deleting field 'Resource.liked'
        db.delete_column(u'resource_resource', 'liked')


        # Changing field 'Resource.downed'
        db.alter_column(u'resource_resource', 'downed', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Resource.viewed'
        db.alter_column(u'resource_resource', 'viewed', self.gf('django.db.models.fields.IntegerField')())
        # Adding field 'Vote.vote'
        db.add_column(u'resource_vote', 'vote',
    ...
    models = {
        ...
        u'resource.resource': {
            ...
            'desc': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'downed': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'}),
            ...
            'viewed': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0'})
        },
        ...
        u'resource.resourcemirror': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('302bb38c-278c-4fa2-b7db-f2fe62bac184')", 'max_length': '64'})
        },
        u'resource.tag': {
        ...
        u'resource.views': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'resource': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'views'", 'to': u"orm['resource.Resource']"}),
