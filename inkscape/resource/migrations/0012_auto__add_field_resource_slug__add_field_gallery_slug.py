...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'resource_resource', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default='SNAIL', max_length=70),
                      keep_default=False)

        # Adding field 'Gallery.slug'
        db.add_column(u'resource_gallery', 'slug',
                      self.gf('django.db.models.fields.CharField')(default='SNAIL', max_length=70),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Resource.slug'
        db.delete_column(u'resource_resource', 'slug')

        # Deleting field 'Gallery.slug'
        db.delete_column(u'resource_gallery', 'slug')
    ...
    models = {
        ...
        u'resource.gallery': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'items': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'galleries'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['resource.Resource']"}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
        ...
        u'resource.quota': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'size': ('django.db.models.fields.IntegerField', [], {'default': '1024'})
        },
        u'resource.resource': {
        ...
        u'resource.resourcemirror': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('dcd75060-ea9a-4bbb-8a8e-fac717ce9396')", 'max_length': '64'})
        },
        u'resource.tag': {
