...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        from inkscape.resource.slugify import set_slug
        for item in orm.Resource.objects.all():
            set_slug(item)
            item.save()
        for item in orm.Gallery.objects.all():
            set_slug(item)
            item.save()
    ...
    models = {
        ...
        u'resource.resourcemirror': {
            ...
            'uuid': ('django.db.models.fields.CharField', [], {'default': "UUID('dd9b722a-a521-4342-935e-3c16bb4beff4')", 'max_length': '64'})
        },
        u'resource.tag': {
